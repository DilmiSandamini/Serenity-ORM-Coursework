...
import lk.ijse.gdse72.serenityormcoursework.tm.PatientTM;
...
public class PatientsFormController implements Initializable {
    ...
    @FXML
    private TableColumn<PatientTM, String> colPatientsEmail;

    @FXML
    private TableColumn<PatientTM, Integer> colPatientsID;

    @FXML
    private TableColumn<PatientTM, String> colPatientsName;

    @FXML
    private TableColumn<PatientTM, String> colTherapyHistory;

    @FXML
    private Label lblID;

    @FXML
    private DatePicker selDOB;

    @FXML
    private TableView<PatientTM> tbtPatients;
    ...
    @FXML
    private TextField txtTherapyHistory;
